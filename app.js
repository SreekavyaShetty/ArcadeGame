...
// randomly assing a column
var setColumn = function() {
    randomFactor();
    if (factor <= 0.20)
        this.x = 0; // sets first column
    else if (factor > 0.20 && factor <= 0.40)
        this.x = 100; // sets second column
    else if (factor > 0.40 && factor <= 0.60)
        this.x = 200; // sets third column
    else if (factor > 0.60 && factor <= 0.80)
        this.x = 300; // sets fourth column
    else
        this.x = 400; // sets fifth column
    return this.x;
};
